    ...
    const registered = (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static">
                <Toolbar style={{background: 'linear-gradient(45deg, #023e8a 30%, #03045e 90%)'}}>
                    <Link to="/" style={{color: 'white', textDecoration: 'none'}}>
                        <img src="https://react-redux-firebase.s3.us-east-2.amazonaws.com/rrf192tArtboard+1.png" alt="logo" style={{width: 45, height: "auto"}}/>
                    </Link>
                    <Link to="/" style={{color: 'white', textDecoration: 'none', marginLeft: 10}}>
                        <Typography
                            variant="h5"
                            noWrap
                            component="div"
